...
<?php include "rmse_md_globalvars.php"; ?>
...
*/
var url = "<?php echo $O3MR_url; ?>";
/* var url = "https://www.emc.ncep.noaa.gov/gmb/yluo/naefs/VRFY_STATS/NCEP_NCEPb/DDDtLLL_VVV_SSS.gif"; */
/* var url = "https://www.emc.ncep.noaa.gov/gmb/STATS_vsdbTTT/allmodel/daily/rmse_md/bias_VVV_HGT_LLL_DDD.png";
...
maptypes.push({
        url: "rmse_md_UGRD.php",
        displayName: "Zonal Wind",
        name: "rmse_md_UGRD",
});
maptypes.push({
        url: "rmse_md_VGRD.php",
        displayName: "Meridional Wind",
        name: "rmse_md_VGRD",
});
maptypes.push({
        url: "rmse_md_UGRD_VGRD.php",
        displayName: "Vector Wind",
        name: "rmse_md_UGRD_VGRD",
});
maptypes.push({
        url: "rmse_md_O3MR.php",
        displayName: "Ozone",
        name: "rmse_md_O3MR",
});
...
function initialize(){
        ...
        imageObj = {
                variable: "<?php echo $Day5_name; ?>",
                domain: "<?php echo $NHem_name; ?>",
                level: "<?php echo $P30_name; ?>",
