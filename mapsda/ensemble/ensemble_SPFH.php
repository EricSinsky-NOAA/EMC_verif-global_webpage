...
<?php include "ensemble_globalvars.php"; ?>
...
variables.push({
        displayName: "Mean",
        name: "<?php echo $Mean_name; ?>",
});
variables.push({
        displayName: "Spread",
        name: "<?php echo $Spread_name; ?>",
});


maptypes.push({
        url: "ensemble_TMP.php",
        displayName: "Temperature",
        name: "ensemble_TMP",
});
maptypes.push({
        url: "ensemble_UGRD.php",
        displayName: "Zonal Wind",
        name: "ensemble_UGRD",
});
maptypes.push({
        url: "ensemble_VGRD.php",
        displayName: "Meridional Wind",
        name: "ensemble_VGRD",
});
maptypes.push({
        url: "ensemble_SPFH.php",
        displayName: "Specific Humidity",
        name: "ensemble_SPFH",
});
maptypes.push({
        url: "ensemble_CLWMR.php",
        displayName: "Cloud Water",
        name: "ensemble_CLWMR",
});
maptypes.push({
        url: "ensemble_O3MR.php",
        displayName: "Ozone",
        name: "ensemble_O3MR",
});
maptypes.push({
        url: "ensemble_PRES.php",
