...
*/
var url = "<?php echo $GHRSST_OSPO_GEOPOLAR_ANL_url; ?>";
...
domains.push({
        displayName: "Global - Sea Ice",
        name: "<?php echo $GlobalSeaIce_name; ?>",
});
domains.push({
        displayName: "Global - Sea Ice Free",
        name: "<?php echo $GlobalSeaIceFree_name; ?>",
});
domains.push({
...
maptypes.push({
        url: "rmse_ghrsst_ncei_avhrr_anl.php",
        displayName: "GHRSST NCEI AVHRR Analysis",
        name: "rmse_ghrsst_ncei_avhrr_anl",
});
maptypes.push({
        url: "rmse_ghrsst_ospo_geopolar_anl.php",
        displayName: "GHRSST OSPO Geo-Polar Analysis",
        name: "rmse_ghrsst_ospo_geopolar_anl",
});
//====================================================================================================^M
//Initialize the page
//====================================================================================================^M
...
function initialize(){
        ...
        imageObj = {
                ...
                season: "<?php echo $Fhr24_name; ?>",
                domain: "<?php echo $Global_name; ?>",
