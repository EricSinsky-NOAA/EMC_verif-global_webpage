...
<?php include "ets_globalvars.php"; ?>
...
Left/Right arrow keys = Change forecast lead | Up/Down arrow keys = Change threshold
<br>For information on precipitation verification, <button class="infobutton" id="myBtn">click here</button>
<div id="myModal" class="modal">
  <div class="modal-content">
    <span class="close">&times;</span>
    Precipitation Verification Information
...
levels.push({
        displayName: "0.2mm",
        name: "<?php echo $Thresh02_name; ?>",
});
levels.push({
        displayName: "2 mm",
        name: "<?php echo $Thresh2_name; ?>",
});
levels.push({
        displayName: "5 mm",
...
levels.push({
        displayName: "10 mm",
        name: "<?php echo $Thresh10_name; ?>",
});
levels.push({
        displayName: "15 mm",
        name: "<?php echo $Thresh15_name; ?>",
});
levels.push({
        displayName: "25 mm",
        name: "<?php echo $Thresh25_name; ?>",
});
levels.push({
        displayName: "35 mm",
        name: "<?php echo $Thresh35_name; ?>",
});
levels.push({
        displayName: "50 mm",
        name: "<?php echo $Thresh50_name; ?>",
});
levels.push({
        displayName: "75 mm",
        name: "<?php echo $Thresh75_name; ?>",
});
levels.push({
        displayName: "All",
        name: "<?php echo $ThreshAll_name; ?>",
});
...
variables.push({
        displayName: "fhr 12-36",
        name: "<?php echo $Fhr12to36_name; ?>",
});
variables.push({
        displayName: "fhr 36-60",
        name: "<?php echo $Fhr36to60_name; ?>",
});
variables.push({
        displayName: "fhr 60-84",
        name: "<?php echo $Fhr60to84_name; ?>",
});
variables.push({
        displayName: "fhr 84-108",
        name: "<?php echo $Fhr84to108_name; ?>",
});
variables.push({
        displayName: "fhr 108-132",
        name: "<?php echo $Fhr108to132_name; ?>",
});
variables.push({
        displayName: "fhr 132-156",
        name: "<?php echo $Fhr132to156_name; ?>",
});
variables.push({
        displayName: "fhr 156-180",
        name: "<?php echo $Fhr156to180_name; ?>",
});
variables.push({
        displayName: "Lead Mean",
...
function initialize(){
        ...
        imageObj = {
                variable: "<?php echo $Fhr12to36_name; ?>",
                domain: "<?php echo $G211_name; ?>",
                level: "<?php echo $Thresh10_name; ?>",
                validtime: "<?php echo $Valid12_name; ?>",
        };
